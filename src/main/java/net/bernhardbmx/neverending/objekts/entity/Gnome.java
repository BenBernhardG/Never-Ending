package net.bernhardbmx.neverending.objekts.entity;
...
public class Gnome extends Animal implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public Gnome(EntityType<? extends Animal> entityType, Level level) {
