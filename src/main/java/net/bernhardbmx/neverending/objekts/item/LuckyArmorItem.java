...
public class LuckyArmorItem extends GeoArmorItem implements IAnimatable {


    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.STEEL_EQUIP,
                            new MobEffectInstance(MobEffects.ABSORPTION, 200, 2)).build();

    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP_2 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.LUCK_EQUIP,
                            new MobEffectInstance(MobEffects.LUCK, 200, 2)).build();
